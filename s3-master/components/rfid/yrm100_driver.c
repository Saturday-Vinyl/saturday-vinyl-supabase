 ...
 * - UART1: GPIO17 (TX to module RX), GPIO18 (RX from module TX)
 * - GPIO5: Module enable pin (active high)
...
/*******************************************************************************
 * Configuration - Pin definitions from app_config.h
 ******************************************************************************/

/* UART and GPIO pins from app_config.h */
#define RFID_TX_PIN             PIN_RFID_TX   /* S3 TX -> YRM100 RX (GPIO17) */
#define RFID_RX_PIN             PIN_RFID_RX   /* S3 RX <- YRM100 TX (GPIO18) */
#define RFID_EN_PIN             PIN_RFID_EN   /* Enable pin (GPIO5, active high) */

/* UART configuration */
#define RFID_BAUD_RATE          RFID_UART_BAUD
