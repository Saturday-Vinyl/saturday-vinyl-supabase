  ...
  Widget _buildStatusSelector(
    ...
    return Wrap(
      ...
      children: [
        ...
        _FilterChipOption(
          label: 'In Production',
          isSelected: filter.status == UnitStatus.inProduction,
          onSelected: () => notifier.setStatus(UnitStatus.inProduction),
          color: SaturdayColors.secondaryGrey,
        ),
        _FilterChipOption(
          label: 'Inventory',
          isSelected: filter.status == UnitStatus.inventory,
          onSelected: () => notifier.setStatus(UnitStatus.inventory),
          color: SaturdayColors.info,
        ),
        _FilterChipOption(
          label: 'Assigned',
          isSelected: filter.status == UnitStatus.assigned,
          onSelected: () => notifier.setStatus(UnitStatus.assigned),
          color: SaturdayColors.warning,
        ),
        _FilterChipOption(
          label: 'Claimed',
          isSelected: filter.status == UnitStatus.claimed,
          onSelected: () => notifier.setStatus(UnitStatus.claimed),
